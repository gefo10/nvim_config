...
local command = {
    ...
    '-jar', home .. '/.local/share/nvim/mason/packages/jdtls/plugins/org.eclipse.equinox.launcher_*.jar',  -- Use the correct path to the launcher JAR
    '-configuration', home .. '/.local/share/nvim/mason/packages/jdtls/config_linux',  -- Path to the JDTLS configuration folder for your OS
    '-data', home .. '/jdtls_workspace',  -- Directory for project data
  }
local config = {
